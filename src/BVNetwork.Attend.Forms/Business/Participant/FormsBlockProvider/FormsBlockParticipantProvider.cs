...
namespace BVNetwork.Attend.Forms.Business.Participant.BlockProvider
{
    public class FormsBlockParticipantProvider : ParticipantProviderBase
    {
        ...
        {
            var contentRepository = ServiceLocator.Current.GetInstance<IContentRepository>();
            return contentRepository.GetChildren<ParticipantBlock>(GetOrCreateParticipantsFolder(EventPageBase).ContentLink, new CultureInfo(Attend.Business.Localization.LanguageHelper.MasterLanguage(EventPageBase)));
        }
