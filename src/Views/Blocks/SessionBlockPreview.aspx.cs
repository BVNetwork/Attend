...
{
     [TemplateDescriptor(Inherited = false, Default = true, AvailableWithoutTag=false, Tags = new[] { RenderingTags.Preview, RenderingTags.Edit }, Path = "~/Modules/BVNetwork.Attend/Views/Blocks/SessionBlockPreview.aspx")]
    public partial class SessionBlockPreview : PreviewPage, IRenderTemplate<SessionBlock>
    {
